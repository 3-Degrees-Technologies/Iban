...
- `docs/development/dev.md` - General .NET development guidance

**'research' and 'architecture' tickets**: 
- Read the Wikipedia article about the topic.
- Check if there exists official resource of the topic, search documentation relevant to our integration/technologies and read that.
- We don't want to reinvent a wheel. Search if there is already available open source resource to help, for example Nuget-package, check the following:
